...
$userName = $_SESSION['name'] ?? ($user['name'] ?? null);
...
$patient     = $patientRepo->getByUserId((int) $userId);
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="flex items-center space-x-8">
                ...
                <a href="index.php?action=logoutAction" class="text-red-500 hover:text-red-700 font-medium transition-colors">Déconnexion</a>
            </div>
        </div>
    </div>
</nav>
...
<main class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-800">
            Bonjour, <?= htmlspecialchars($userName ?? 'Patient') ?> 👋
        </h1>
