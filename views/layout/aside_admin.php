...
<aside class="fixed inset-y-0 left-0 z-20 hidden w-64 bg-slate-900 border-r border-slate-800 lg:flex lg:flex-col justify-between">
    <div class="flex flex-col flex-1 p-6 overflow-y-auto">
        ...
        <nav id="sidebar-nav" class="space-y-1 text-xs font-medium flex-1">
            ...
            <a href='<?php echo $baseUrl; ?>/index.php?action=admin_dashboard' class="flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-slate-800/60 hover:text-white text-slate-400 transition-all">
                <i class="fa-solid fa-chart-pie text-sm"></i>
                <span>Vue d'ensemble (KPIs)</span>
            </a>
            
            <a href='<?php echo $baseUrl; ?>/index.php?action=tableDoctorsAction' class="flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-slate-800/60 hover:text-white text-slate-400 transition-all">
                <i class="fa-solid fa-user-doctor text-sm"></i>
                <span>Gestion des Médecins</span>
            </a>
            
            <a href='<?php echo $baseUrl; ?>/admin/table_specialites.php' class="flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-slate-800/60 hover:text-white text-slate-400 transition-all">
            ...
            <a href='<?php echo $baseUrl; ?>/admin/table_doctors.php' class="flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-slate-800/60 hover:text-white text-slate-400 transition-all">
                <i class="fa-regular fa-calendar-check text-sm"></i>
                <span>Gestion des médecin</span>
            </a>

            <a href='<?php echo $baseUrl; ?>/admin/table_patients.php' class="flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-slate-800/60 hover:text-white text-slate-400 transition-all">
                <i class="fa-solid fa-users text-sm"></i>
                <span>Registre des Patients</span>
            </a>

            <a href='<?php echo $baseUrl; ?>/admin/table_logs.php' class="flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-slate-800/60 hover:text-white text-slate-400 transition-all">
    ...
    <div class="p-4 border-t border-slate-800">
        <a href='<?php echo $baseUrl; ?>/index.php?action=logoutAction' class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-rose-400 hover:bg-rose-950/20 hover:text-rose-300 transition-all text-xs font-medium">
